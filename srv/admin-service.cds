...
service AdminService @(requires : 'admin') {
  ...
  entity DistinctSex as projection on my.DistinctSex { key EventId, key ID : String, Name: String, Total: Decimal };
  entity DistinctTshirt as projection on my.DistinctTshirt { key EventId, key ID, Name: String, Total: Decimal };
